...
def create_rootfs_ext4_image2(rootfs_base_dir: pathlib.Path, image_output_path: pathlib.Path, image_size_mb: int = 512):
    """
    Erstellt eine leere EXT4-Image-Datei, kopiert den Inhalt des Rootfs dorthin
    und hängt das Image anschließend aus.
...
def main():
    ...
    create_bootfs_vfat_image(output_bootfs_image_path, build_dir / "firmware", bootfs_image_size)
